...
const char *get_tpm_code(uint_32_t value)
{
    switch (value){
        ...
        case TPM_CC_EncryptDecrypt2:
            return "TPM_CC_EncryptDecrypt2";
        case TPM_CC_AC_GetCapability:
            return "TPM_CC_AC_GetCapability";
        case TPM_CC_AC_Send:
            return "TPM_CC_AC_Send";
        case TPM_CC_Policy_AC_SendSelect:
            return "TPM_CC_Policy_AC_SendSelect";
        case TPM_CC_CertifyX509:
            return "TPM_CC_CertifyX509";
        case TPM_CC_ACT_SetTimeout:
            return "TPM_CC_ACT_SetTimeout";
        case TPM_CC_ECC_Encrypt:
            return "TPM_CC_ECC_Encrypt";
        case TPM_CC_ECC_Decrypt:
            return "TPM_CC_ECC_Decrypt";
        case TPM_CC_Vendor_TCG_Test:
            return "TPM_CC_Vendor_TCG_Test";
        default :
            return "CC_VEND"; 
            //CC_VEND is int
    }
